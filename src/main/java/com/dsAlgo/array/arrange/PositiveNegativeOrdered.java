...
class PositiveNegativeOrderedSolution {
...
public class PositiveNegativeOrdered {
    public static void main(String[] args) {
        ...
        int forwIndex = 0, revIndex = arr.size();
        for (Integer integer : arr) {
            if (integer < 0) {
                ansArr.set(forwIndex++, integer);
            }
            if (integer == 0) {
                continue;
            }
            if (integer >= 0) {
                ansArr.set(--revIndex, integer);
            }
        }
        PositiveNegativeOrderedSolution solution = new PositiveNegativeOrderedSolution();
