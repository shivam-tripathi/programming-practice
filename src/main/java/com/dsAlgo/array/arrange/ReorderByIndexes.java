...
class ReorderByIndexesSolution {
...
public class ReorderByIndexes {
    public static void main(String[] args) {
        ...
        for (Integer item: index) System.out.printf("%3d", item); System.out.println();

        ReorderByIndexesSolution sol = new ReorderByIndexesSolution();
