...
public class ReorderByValue {
    public static void main(String args[]) {
        ReorderByValueSolution sol = new ReorderByValueSolution();
        Integer a[]  = {2, 0, 1, 4, 5, 3};
        ArrayList<Integer> arr = new ArrayList<Integer>(Arrays.asList(a));
        for (Integer item: sol.reorder(new ArrayList<>(arr))) System.out.print(item + " "); System.out.println();
        for (Integer item: sol.reorderNoCycle(new ArrayList<>(arr))) System.out.print(item + " "); System.out.println();
    }
}
