 ...
 *
 * Example 2: Input: root = [10,5,15,3,7,13,18,1,null,6], low = 6, high = 10
 * Output: 23 Explanation: Nodes 6, 7, and 10 are in the range [6, 10]. 6 + 7 +
 * 10 = 23.
 *
 * Constraints: The number of nodes in the tree is in the range [1, 2 * 104]. 1
