...
func getIntersectionNode(headA, headB *ListNode) *ListNode {
	...
	move, movedHead, staticHead := a, headA, headB

	if a == nil {
		move, movedHead, staticHead = b, headB, headA
	}
	...
	for movedHead != staticHead {
		movedHead, staticHead = movedHead.Next, staticHead.Next
	}
