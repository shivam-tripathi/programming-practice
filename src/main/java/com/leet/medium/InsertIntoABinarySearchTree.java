 ...
 *
 * Example 1:
 * Input: root = [4,2,7,1,3], val = 5 Output: [4,2,7,1,3,5] Explanation: Another accepted tree
 * is:
 *
 * Example 2:
 ...
 *
 * Constraints:
 * The number of nodes in the tree will be in the range [0, 104]. -108 <= Node.val <= 108 All the
 * values Node.val are unique. -108 <= val <= 108 It's guaranteed that val does not exist in the
 * original BST.
 */
