 ...
 * value of b is 2, the numeric value of c is 3, and so on. The numeric value of
 * a string consisting of lowercase characters is defined as the sum of its
 ...
 * prefix of y, or if i is the first position such that x[i] != y[i], then x[i]
 * comes before y[i] in alphabetic order. Example 1:
 *
 * Input: n = 3, k = 27 Output: "aay" Explanation: The numeric value of the
 * string is 1 + 1 + 25 = 27, and it is the smallest string with such a value
