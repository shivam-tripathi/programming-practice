 ...
 *
 * Example 1: Input: nums = [1,2,5,9], threshold = 6 Output: 5 Explanation: We
 * can get a sum to 17 (1+2+5+9) if the divisor is 1. If the divisor is 4 we can
 * get a sum of 7 (1+1+2+3) and if the divisor is 5 the sum will be 5 (1+1+1+2).
 *
 * Example 2: Input: nums = [44,22,33,11,1], threshold = 5 Output: 44
 *
 * Constraints: 1 <= nums.length <= 5 * 104 1 <= nums[i] <= 106 nums.length <=
 * threshold <= 106
 */

public class FindTheSmallestDivisorGivenAThreshold {
	public int smallestDivisor(int[] nums, int threshold) {
		int begin = 1, end = (int) 1e6 + 10, mid = -1;
		while (begin <= end) {
