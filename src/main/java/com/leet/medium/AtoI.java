 ...
 * range [-231, 231 - 1], the final result is 0.
 *
 * Example 5:
 *
...
public class AtoI {
	public int myAtoi(String s) {
		...
		// determine breakpoint and offset from breakpoint
		int collect = 0;
		int breakpoint = neg ? -(cmp / 10) : cmp / 10; // abs value
		int offset = neg ? -(cmp % 10) : cmp % 10; // abs value

		// iterate over all characters and add checks over collect (instead of string s)
