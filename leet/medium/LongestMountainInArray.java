...
class LongestMountainInArray {
  public static void main(String[] args) {
    ...
    Integer[] A = (Integer[]) Arrays.asList(inp.split(",")).stream().map(Integer::parseInt).collect(Collectors.toList()).toArray();
    System.out.println(new LongestMountainInArraySolution2().longestMountain(A);
  }
}
